...
namespace AYTEmployees.Platforms.Android
{
    public partial class AndroidWifiNetworkService : IWifiNetworkService
    {
        ...
        public AndroidWifiNetworkService()
        {
        ...
        public async Task<NetworkData> GetNetworkInfo()
        {
            ...
            if (apiLevel < 31)
            {
                ...
                if (_wifiManager.IsWifiEnabled)
                {
                    ...
                    _networkData.MacAddress = wifiInfo.MacAddress;
