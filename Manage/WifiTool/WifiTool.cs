...
using System;
#if IOS
using AYTEmployees.Platforms.iOS;
#elif WINDOWS
using AYTEmployees.Platforms.Windows;
#elif ANDROID
using AYTEmployees.Platforms.Android;
#else
//using AYTEmployees.Platforms.Windows;
#endif
...
namespace AYTEmployees.WifiTool
{
    ...
    public static class WifiTool
    {
        ...
        static IWifiNetworkService CreateWifiManager()
        {
            ...
            //return new WinWifiNetworkService();
#if IOS
                        return new IOSWifiNetworkService();
#elif WINDOWS
                        return new WinWifiNetworkService();
#elif ANDROID
            return new AndroidWifiNetworkService();
